...
import VisiMisiScreen from '../screen/informasi/VisiMisiAppScreen'
import StrukturOrganisasiScreen from '../screen/informasi/StrukturOrganisasiAppScreen';
...
const AppStack = () => {
      ...
      useEffect(() => {
            ...
            OneSignal.addEventListener('received', onIds)
      }, [])
    ...
    return(
      loadingAuth ? 
        ...
        <Drawer.Navigator>
              ...
              <Drawer.Screen name='Visi & Misi' component={VisiMisiScreen}/>
              <Drawer.Screen name='Struktur Organisasi' component={StrukturOrganisasiScreen}/>
